...
static struct __pyx_t_3PMD_10InputQueue_InputQueue_t __pyx_f_3PMD_10InputQueue_init(int __pyx_v_depth) {
  struct __pyx_t_3PMD_10InputQueue_InputQueue_t __pyx_v_new_queue;
  struct __pyx_t_3PMD_10InputQueue_InputQueue_t __pyx_r;
 ...
 *     new_queue._front = 0
 */
  __pyx_v_new_queue._depth = __pyx_v_depth;
 ...
 *     new_queue._back = 0
 */
  __pyx_v_new_queue._queue = ((struct __pyx_t_5types_event_t *)malloc((__pyx_v_depth * (sizeof(struct __pyx_t_5types_event_t)))));
 ...
 * 
 */
  __pyx_v_new_queue._count = 0;

  /* "PMD/InputQueue.pyx":12
 *     new_queue._back = 0
 *     new_queue._count = 0
 *     return new_queue             # <<<<<<<<<<<<<<
 * 
...
if (!__Pyx_RefNanny) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "PMD.InputQueue")) {
      if (unlikely(PyDict_SetItemString(modules, "PMD.InputQueue", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
