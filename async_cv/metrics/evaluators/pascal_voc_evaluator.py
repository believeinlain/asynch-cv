...
import numpy as np
# import pandas as pd
from async_cv.metrics.bounding_box import BoundingBox
from async_cv.metrics.utils.enumerators import (BBFormat, CoordinatesType,
...
def get_pascalvoc_metrics(gt_boxes,
    ...
    Returns:
        A dictionary contains information and metrics of each class.
    ...
    for c, v in classes_bbs.items():
        ...
        # if table generation is needed, install pandas
        # if generate_table:
